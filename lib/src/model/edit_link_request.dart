...
class EditLinkRequest {
  /// Returns a new [EditLinkRequest] instance.
  EditLinkRequest({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EditLinkRequest &&
     other.url == url &&
     other.domain == domain &&
     other.key == key &&
  ...
  factory EditLinkRequest.fromJson(Map<String, dynamic> json) => _$EditLinkRequestFromJson(json);

  Map<String, dynamic> toJson() => _$EditLinkRequestToJson(this);
