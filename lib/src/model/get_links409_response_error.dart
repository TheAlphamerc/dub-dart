...
part 'get_links409_response_error.g.dart';
...
class GetLinks409ResponseError {
  /// Returns a new [GetLinks409ResponseError] instance.
  ...
  final GetLinks409ResponseErrorCodeEnum code;
  ...
  Map<String, dynamic> toJson() => _$GetLinks409ResponseErrorToJson(this);
